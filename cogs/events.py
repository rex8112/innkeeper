...
class Events(commands.Cog):
    ...
    async def on_guild_join(self, guild):
        ...
        embed = discord.Embed(title='Hello {}'.format(owner.name), colour=Colour.infoColour, 
                              description='I appreciate you taking an interest in the adventures I can offer. However, for me to offer my services correctly, I am going to need some assistance setting up. If either you or an administrator of **{0}** could run the `{1}settings` \
